...
# Imports 
import time
from zookeeperyarascan import yarascan
from zookeeperhashes import Hasher
from zookeeperstrings import strings
from zookeepergeneral_info import GeneralInformation
from zookeeperpe import PeInfo
#from modules.database import MongoDatabase
from zookeepersample_storager import add_to_repository
...
def do_work(sample_path):
    ...
    try:
        ...
        pe_info         = PeInfo(sample, 'zookeeperuserdb.txt')
