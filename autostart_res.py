...
def autostart(database):
    ...
    Lobotomy.add_to_queue('python ' + Lobotomy.plugin_dir + 'pstree.py {}'.format(database))
    Lobotomy.add_to_queue('python ' + Lobotomy.plugin_dir + 'cmdline.py {}'.format(database))
    Lobotomy.add_to_queue('python ' + Lobotomy.plugin_dir + 'prefetchparser.py {}'.format(database))
    Lobotomy.add_to_queue('python ' + Lobotomy.plugin_dir + 'hivelist.py {}'.format(database))
    ...
    Lobotomy.add_to_queue('python ' + Lobotomy.plugin_dir + 'multiparser.py {} ldrmodules'.format(database))
    ...
    Lobotomy.add_to_queue('python ' + Lobotomy.plugin_dir + 'strings.py {}'.format(database))
    Lobotomy.add_to_queue('python ' + Lobotomy.plugin_dir + 'hivedump.py {}'.format(database))
    #if 'XP' in profile:
