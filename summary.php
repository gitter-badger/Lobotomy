...
<ul class="summary_list">
    ...
    <li><span><?php echo $counter['bad_hashes']; ?></span> known <strong>bad</strong> hashes are in the database</li>
    <li><span><?php echo $counter['good_hashes']; ?></span> known <strong>good</strong> hashes are in the database</li>
</ul>